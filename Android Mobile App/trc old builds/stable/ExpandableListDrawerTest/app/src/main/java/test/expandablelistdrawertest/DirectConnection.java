...
final class DirectConnection extends Thread
{
    ...
    public DirectConnection(String address, int port)
    {
    ...
    public void run()
    {
        ...
        {
            Log.e(TAG, "Count not connect to address:port, maybe not connected to correct network?");
            e.printStackTrace();
        } catch (IOException e)
        {
        ...
        if (this.dataSocket != null)
        {
            while (this.dataSocket.isConnected())
            {
                ...
                try
                {
                    ...
                    //Log.d(TAG, "Read from stream: " + intByte + "(dec)");
    ...
    public void connect()
    {
        try
        {
            dataSocket.connect(new InetSocketAddress(ipAddress,portNumber));
        } catch (IOException e)
        {
            e.printStackTrace();
        }
